        ...
        <div class="container">
            <div class="row">
                ...
                <div class="d-flex justify-content-between">
                    <div class="card"
                        style="width: 20rem; border-radius: 10px; border-style: none; box-shadow: 0px 10px 20px -10px #A18AFF;">
                        <div class="card-body">
